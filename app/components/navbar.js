      ...
      <div className="flex items-center gap-2">
        ...
        <Link href="/" className="flex items-center gap-3 p-4">
          <Image 
            ...
            priority
          />
          <span className="text-2xl font-bold top-0 left-5"><h1>PRAG To Do</h1></span>
        </Link>

        {/* Navbar links */}
        <nav>
          <ul className="flex gap-x-4 fixed top-1 right-30 p-4">
            <li>
              <Link href='/' className="hover:text-blue-600 transition">Home</Link>
            </li>
            <li>
              <Link href='/my-lists' className="hover:text-blue-600 transition">My Lists</Link>
            </li>
            <li>
              <Link href='/reward' className="hover:text-blue-600 transition">Reward</Link>
            </li>
            <li>
